---
title: Modern Color Science for Motion Picture Production
...
<div class="module-grid">
  ...
  <article class="module-card">
    <a href="/misc/colorimetry/module-1/" class="module-card-link">
      ...
      <p class="module-excerpt">
        The eye is not a camera—it's a brain peripheral. Understanding biological color vision before diving into digital workflows.
      </p>
    ...
    <a href="/misc/colorimetry/module-2/" class="module-card-link">
      ...
      <nav class="module-outline" aria-label="Module 2 outline">
        <ul>
          ...
          <li>2.2 The Holy Grail: CIE 1931 XYZ</li>
          <li>2.3 Perceptual Uniformity Attempts</li>
          <li>2.4 The Analog Legacy</li>
        </ul>
      </nav>
      <div class="module-cta">
  ...
  <article class="module-card">
    <a href="/misc/colorimetry/module-3/" class="module-card-link">
      ...
      <p class="module-excerpt">
        Scene-referred vs. display-referred workflows, color models (RGB, YUV, HSL), transfer functions (OETF/EOTF), and gamut mapping fundamentals.
      </p>
      <nav class="module-outline" aria-label="Module 3 outline">
        <ul>
          ...
          <li>3.4 Gamut Fundamentals & Mapping</li>
        </ul>
      </nav>
      <div class="module-cta">
